(function (factory) {
    ...
    JSROOT.Create = function (typename, target) {
        ...
        switch (typename) {
            ...
            case 'TGraph':
                ...
                JSROOT.Create("TAttMarker", obj);
                JSROOT.extend(obj, {
                    fFunctions: JSROOT.Create("TList"), fHistogram: null,
            ...
            case 'TMultiGraph':
                JSROOT.Create("TNamed", obj);
                JSROOT.extend(obj, {
                    fFunctions: JSROOT.Create("TList"), fGraphs: JSROOT.Create("TList"),
    ...
    JSROOT.Initialize = function () {
        ...
        if (bower !== null) {
            if (bower.length > 0) JSROOT.bower_dir = bower; else if (JSROOT.source_dir.indexOf("jsroot/") === JSROOT.source_dir.length - 7)
        ...
        if ((prereq.length > 0) || (onload != null))
            window_on_load(function () {
                if (prereq.length > 0) JSROOT.AssertPrerequisites(prereq, onload); else if (onload != null) {
